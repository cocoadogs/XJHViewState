...
Pod::Spec.new do |s|
  s.name             = 'XJHViewState'
  s.version          = '0.1.0'
  s.summary          = 'A short description of XJHViewState.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/许君浩/XJHViewState'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '许君浩' => 'cocoadogs@163.com' }
  s.source           = { :git => 'https://github.com/许君浩/XJHViewState.git', :tag => s.version.to_s }
